...
export const demoGachaDataset: GachaDataset = {
  ...
  items: [
    { id: 'power-elixir', name: 'Power Elixir', category: 'Use', rarity: 'common' },
    { id: 'summoning-rock', name: 'Summoning Rock', category: 'Etc', rarity: 'common' },
    { id: 'work-gloves', name: 'Work Gloves', category: 'Equip', rarity: 'uncommon' },
    { id: 'brown-bamboo-hat', name: 'Brown Bamboo Hat', category: 'Equip', rarity: 'rare' },
    { id: 'pink-adventurer-cape', name: 'Pink Adventurer Cape', category: 'Equip', rarity: 'epic' },
    { id: 'chaos-scroll-demo', name: 'Chaos Scroll (Demo)', category: 'Scroll', rarity: 'legendary' },
  ],
  rates: [
